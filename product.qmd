...
-   In the country column, we have individual countries (like Afghanistan, Albania, Algeria, etc.), regions (such as Africa, Asia, Europe), specific groupings or categories (like OECD, OPEC, High-income countries.
...
owid_energy |> 
  ...
  labs(
    x = "GDP (trillions$)",
    y = "Greenhouse Gas Emissions (megatonnes)"
  ) +
